                                ...
                                <div class="tab-pane fade show active" id="signin" role="tabpanel"
                                    ...
                                    <form action="{{url('login')}}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="email_or_mobile">شماره موبایل خود را وارد کنید *</label>
                                            <input type="text" class="form-control" id="email_or_mobile" value="{{old('email_or_mobile')}}"
                                                   name="email_or_mobile" required>
                                        </div><!-- End .form-group -->
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby=" -tab">
                                   <div class="text-danger">
                                    ...
                                    <form action="{{route('register')}}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="mobile_number">شماره موبایل شما *</label>
                                            <input type="text" minlength="11" maxlength="11" value="{{old('mobile_number')}}" class="form-control" id="mobile_number"
